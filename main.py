...
#Em seu turno, os jogadores tentam adivinhar a posição dos navios inimigos informando
# a posição no mapa, caso acerte, exibir o tamanho do navio, caso erre, exibir 1
